...
public class UserController {
    ...
    @PostMapping("/login")
    public String login(@RequestBody com.vbs.demo.Dto.LoginDto u)
    ...
    public com.vbs.demo.dto.DisplayDto display(@PathVariable int id)
    {
        User user = userRepo.findById(id)
                .orElseThrow(()->new RuntimeException("User not found"));
        com.vbs.demo.dto.DisplayDto dto = new com.vbs.demo.dto.DisplayDto();
        com.vbs.demo.dto.DisplayDto displayDto = new com.vbs.demo.dto.DisplayDto();
   ...
   public String add(@RequestBody User user, @PathVariable int adminId)
    {
        History h1 = new History();
        h1.setDescription("User "+user.getUsername()+"Created By admin :");
